...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Upload data file to S3 or create database")
    subparsers = parser.add_subparsers(dest='subparser_name')

    # Upload file to specified S3 bucket
    sp_upload = subparsers.add_parser("upload", description = "Upload data folder to specified S3 bucket")
    sp_upload.add_argument("bucket_name", help = "Name of S3 bucket")
    sp_upload.add_argument("file_name", help = "File name (key)")
    sp_upload.add_argument("-d", "--data_path", default=DATA_PATH, \
