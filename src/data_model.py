...
class Recipe(Base):
    ...
    cuisineid = Column(
        ForeignKey("cuisines.cuisineid"), unique=False, nullable=False
    )
...
class RecipeIngredient(Base):
    ...
    recipeid = Column(
        ForeignKey("recipes.recipeid"), unique=False, nullable=False
    )
    ingredientid = Column(
        ForeignKey("ingredients.ingredientid"), unique=False, nullable=False
    )
